...
class ChatGPT {
    ...
    */
    constructor(apiKey) {
        HelperFunctions.validateKeyString(apiKey, 'API key is required for initializing ChatGPT instance');
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during generation
    */
    async createModeration(input, modelID="omni-moderation-latest") {
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during generation
    */
    async createSpeech(input, destinationFolder, modelID="tts-1", voice="alloy", response_format="mp3", newConfig={}) {
        return this.client.createSpeech(input, destinationFolder, modelID, voice, response_format, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async getFineTuningJobEvents(fine_tuning_job_id, newConfig={}){
        return this.client.getFineTuningJobEvents(fine_tuning_job_id, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async getFineTuningJobCheckpoints(fine_tuning_job_id, newConfig={}){
        return this.client.getFineTuningJobCheckpoints(fine_tuning_job_id, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during generation
    */
    async createFineTuningJob(training_file_id, modelID="gpt-4o-mini", newConfig={}) {
        return this.client.createFineTuningJob(training_file_id, modelID, newConfig);
    }
