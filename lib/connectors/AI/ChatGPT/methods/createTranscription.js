...
*/
async function createTranscription(httpRequest, throwError, filePath, modelID, newConfig) {
    ...
    try {
        ...
        const response = await httpRequest.post('/audio/transcriptions', formData, {
