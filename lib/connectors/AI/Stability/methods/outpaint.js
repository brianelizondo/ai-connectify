...
*/
async function outpaint(httpRequest, throwError, pathImage, destinationFolder, output_format, newConfig){
    ...
    try {
        ...
        const response = await httpRequest.postForm('/stable-image/edit/outpaint', formData, {
            validateStatus: null,
