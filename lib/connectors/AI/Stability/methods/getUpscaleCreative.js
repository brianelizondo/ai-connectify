...
*/
async function getUpscaleCreative(httpRequest, throwError, upscaleId, destinationFolder, output_format, newConfig){
    ...
    try {
        ...
        const response = await httpRequest.get(`/stable-image/upscale/creative/${upscaleId}`, formData, {
            validateStatus: null,
        ...
        if (response.status === 202) {
            ...
            const urlImage = `./${approveDestinationFolder}/${upscaleId}.${output_format}`;
