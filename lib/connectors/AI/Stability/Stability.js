...
class Stability {
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async generateImageDiffusion(prompt, destinationFolder, strength, modelID="sd3.5-medium", mode="text-to-image", output_format="png", newConfig={}){
        return this.client.generateImageDiffusion(prompt, destinationFolder, strength, modelID, mode, output_format, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async getUpscaleCreative(upscaleId, destinationFolder){
        return this.client.getUpscaleCreative(upscaleId, destinationFolder);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async outpaint(pathImage, destinationFolder, output_format="png", newConfig={}){
        return this.client.outpaint(pathImage, destinationFolder, output_format, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async controlStyle(prompt, pathImage, destinationFolder, output_format="png", newConfig={}){
        return this.client.controlStyle(prompt, pathImage, destinationFolder, output_format, newConfig);
    }
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during the request
    */
    async imageToVideo(pathImage, cfg_scale=1.8, motion_bucket_id=127, seed=0){
        return this.client.imageToVideo(pathImage, cfg_scale, motion_bucket_id, seed);
    }
