...
class ChatGPT {
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during generation
    */
    async createCompletion(promptText, modelID = "text-davinci-003", config = {}) {
        // Preview inputs validations
    ...
    * @throws {AIConnectifyError} - Will throw an error if an error occurs during generation
    */
    async createChatCompletion(messagesArray, modelID = "gpt-3.5-turbo", config = {}) {
        // Preview inputs validations
    ...
    * @param {Object} [config={}] - Optional parameters for the completion generation
    ...
    */
    async createEdit(instruction, input = null, modelID = "text-davinci-edit-001", config = {}) {
        // Preview inputs validations
