...
class CohereClient {
    ...
    */
    setClientName(clientName){
        ValidationHelpers.validateStringInput(message, 'Cannot process the client name');
    ...
    */
    async chat(message, modelID, newConfig) {
        ValidationHelpers.validateStringInput(message, 'Cannot process the message');
    ...
    */
    async rerannk(query, documments, modelID, newConfig) {
        ...
        ValidationHelpers.validateArrayInput(documments, 'Cannot process the documments array');
        ValidationHelpers.validateStringInput(modelID, 'Cannot process the model ID');
    ...
    */
    async getConnector(connector_id) {
        ValidationHelpers.validateStringInput(modelID, 'Cannot process the connector ID');
