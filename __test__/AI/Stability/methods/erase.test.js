import erase from '../../../../lib/connectors/AI/Stability/methods/erase';
...
describe("Stability - erase method", () => {
    let httpRequestMock;
    let throwErrorMock;
    // test variables
    ...
    describe('API Interaction', () => {
        it('Test make a POST request to the correct endpoint', async () => {
            ...
            const response = await erase(httpRequestMock, throwErrorMock, pathImage, destinationFolder, output_format, config);
    ...
    describe("Throw the AIConnectifyError error", () => {
        ...
        it('Test handle API errors correctly', async () => {
            ...
            await erase(httpRequestMock, throwErrorMock, pathImage, destinationFolder, output_format, config);
