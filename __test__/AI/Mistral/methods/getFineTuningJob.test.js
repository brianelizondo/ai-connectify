import getFineTuningJob from '../../../../lib/connectors/AI/Mistral/methods/getFineTuningJob';

describe("Mistral - getFineTuningJob method", () => {
    let httpRequestMock;
    let throwErrorMock;
    // test variables
    ...
    describe('API Interaction', () => {
        it('Test make a GET request to the correct endpoint', async () => {
            ...
            const response = await getFineTuningJob(httpRequestMock, throwErrorMock, fine_tuning_job_id);

            expect(httpRequestMock.get).toHaveBeenCalledTimes(1);
            expect(httpRequestMock.get).toHaveBeenCalledWith(`/fine_tuning/jobs/${fine_tuning_job_id}`);
    ...
    describe("Throw the AIConnectifyError error", () => {
        ...
        it('Test handle API errors correctly', async () => {
            ...
            await getFineTuningJob(httpRequestMock, throwErrorMock, fine_tuning_job_id);
