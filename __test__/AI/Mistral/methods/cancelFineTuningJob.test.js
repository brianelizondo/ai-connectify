import cancelFineTuningJob from '../../../../lib/connectors/AI/Mistral/methods/cancelFineTuningJob';

describe("Mistral - cancelFineTuningJob method", () => {
    let httpRequestMock;
    let throwErrorMock;
    // test variables
    ...
    describe('API Interaction', () => {
        it('Test make a POST request to the correct endpoint', async () => {
            ...
            const response = await cancelFineTuningJob(httpRequestMock, throwErrorMock, fine_tuning_job_id);

            expect(httpRequestMock.post).toHaveBeenCalledTimes(1);
            expect(httpRequestMock.post).toHaveBeenCalledWith(`/fine_tuning/jobs/${fine_tuning_job_id}/cancel`);
    ...
    describe("Throw the AIConnectifyError error", () => {
        ...
        it('Test handle API errors correctly', async () => {
            ...
            await cancelFineTuningJob(httpRequestMock, throwErrorMock, fine_tuning_job_id);
